...
class Book(models.Model):
    ...
    slug = models.SlugField(default="", null=False, db_index=True) # SlugField is used to create SEO friendly URLs, it is a short label for something containing only letters, numbers, underscores or hyphens.
